...
public class CalculadoraEstadisticas
{
	...
	// ************************************************************************
	// Aqui son las funciones de consulta del laboratorio
	// ************************************************************************

	/**
	 * Retorna el pais de un atleta y tiene como parametro el nombre del atleta
	 */
	public String paisdeatleta(String atleta)
	{
		Pais resultado1 = null;
		String resultado = null;

		for (Atleta unAtleta : atletas)
		{
			
			if (atleta.equals( unAtleta.darNombre()) && resultado == null)
			{
				
				resultado1 =  unAtleta.darPais();
				resultado = resultado1.darNombre();
			}
