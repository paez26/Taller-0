...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		/*
		 * Se agrega nueva opcion 
		 */
		System.out.println("14. Consultar pais del atleta");
	}
	...
	/**
	 * Esta es la nueva funcion que encuentra el pais de un atleta
	 */
	private void ejecutarpaisdelatleta()
	{
		...
		String redondeado = calculadora.paisdeatleta(nombre);
		System.out.println("El pais del atleta es " + redondeado );
